  ...
  return (
    <>
      <Box>
        ...
        <Box style={{boxShadow: "rgba(100, 100, 111, 0.2) 0px 7px 29px 0px", width : "60%", margin : "auto", padding : "5% 0% 10% 15%"}}>
          <Flex style={{border : "1px solid grey", padding : "10px", width : "70%", marginBottom : "20px"}}>
          ...
          <Box>
            <Button style={{width : "70%", color :"white", backgroundColor : "#30e32a"}} onClick={handleDateTime}>CONTINUE</Button>
          </Box>
        </Box>
      </Box>
    </>
